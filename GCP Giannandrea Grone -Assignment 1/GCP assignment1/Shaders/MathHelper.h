...
class MathHelper {
public:
	// multiplication of 2 4x4 matrices
	static void matrixMult4x4 (GLfloat* result, GLfloat* m1, GLfloat* m2);
	// This is a column-order matrix multiply of matrices
	...
	// Copies the source matrix into the dest matrix
	static void copyMatrix (GLfloat* src, GLfloat* dest);
	//simply print the matrix valuesin the console
